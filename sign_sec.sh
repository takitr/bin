...
function Usage()
{
	echo "Please input: sign_sec.sh xxx.zip"
}
if [ $# != 1 ];then
	Usage
	exit 0
...
java -Xmx1536m -jar $KEY_PATH/signapk.jar -w $KEY_PATH/securekey/releasekey.x509.pem $KEY_PATH/securekey/releasekey.pk8 $1 update.zip
